...
[최신 버전 다운로드](https://github.com/yeonijae/realcap/releases/latest)
...
각 릴리스의 `SHA256SUMS.txt`에서 설치 파일의 SHA-256 값을 확인할 수 있습니다. `Source code`로 표시되는 자동 압축 파일에는 이 저장소의 문서만 포함되며, 설치 파일은 아닙니다.
